#ifndef SCREENACTUATEARWENMANYSTATUS2_H_INCLUDED
#define SCREENACTUATEARWENMANYSTATUS2_H_INCLUDED

//---------------------------------------------------------------------------
#include "SCREEN.h"
//---------------------------------------------------------------------------
class ScreenActuateArwenManyStatus2:public SCREEN
{
    public:
      ScreenActuateArwenManyStatus2(void);
      ~ScreenActuateArwenManyStatus2(void);
    ...
    private:
      ...
      DISP_WORD markActCount[4][3];
      DISP_WORD markActEndMode[4];

      DISP_WORD markExtend;
      DISP_WORD markGapOut;
/*      DISP_WORD markArriveMinGreenTime;
      DISP_WORD markExtenTime[2];
      DISP_WORD markStopGreen[2]; */
      DISP_WORD markMinGreenTime[3];
      ...
      short int ilastActCount[4];
      short int ilastActEndMode[4];
      ...
      unsigned short int iDnyActCount,iDnyActEnd;
      ...
      short int RecordDnyActCount;
      short int RecordDnyActEnd;
...
//---------------------------------------------------------------------------
extern ScreenActuateArwenManyStatus2 screenActuateArwenManyStatus2;

#endif // SCREENACTUATEARWENMANYSTATUS2_H_INCLUDED
