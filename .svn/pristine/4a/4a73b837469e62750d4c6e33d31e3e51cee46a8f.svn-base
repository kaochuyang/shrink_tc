/*
 * ScreenActuateArwenFlashManyStatus.h
 *
 *  Created on: 2010/10/8
 *      Author: arwen
 */

#ifndef SCREENACTUATEARWENFLASHMANYSTATUS_H_
#define SCREENACTUATEARWENFLASHMANYSTATUS_H_

#include "SCREEN.h"

class ScreenActuateArwenFlashManyStatus: public SCREEN {
public:
	ScreenActuateArwenFlashManyStatus();
	virtual ~ScreenActuateArwenFlashManyStatus();
	 void DisplayActuateArwenFlashManyStatus(void);
	...
	/*      DISP_WORD markArriveMinGreenTime;
	      ...
	      DISP_WORD markALLGreenTime[4][3];
...
extern ScreenActuateArwenFlashManyStatus screenActuateArwenFlashManyStatus;
#endif /* SCREENACTUATEARWENFLASHMANYSTATUS_H_ */
