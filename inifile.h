...
class CIniFileA
{
	...
	public:
		...
		// XML Save Arwen ++ 1001006
		bool Save_HEAD_XML( const std::string& fileName ,int typemode,std::string Section);
        bool Save_INT_XML( const std::string& fileName,std::string Section1,std::string Section2,std::string stmp );
